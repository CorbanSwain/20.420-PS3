    ...
    function print_stats(descr, stats, ftest_out)
        ...
        for i = 1:n
            ...
            mono{2} = sprintf('(%.2e, %.2e), (%.2e, %.2e)', ...
                sm.conf(:,1)-sm.params(1), sm.conf(:,2)-sm.params(2));
            ...
            bi{2} = sprintf(['(%.2e, %.2e), (%.2e, %.2e),' ...
                ' (%.2e, %.2e), (%.2e, %.2e)'], ...
                sb.conf(:,1)-sb.params(1), sb.conf(:,2)-sb.params(2),...
                sb.conf(:,3)-sb.params(3), sb.conf(:,4)-sb.params(4));
